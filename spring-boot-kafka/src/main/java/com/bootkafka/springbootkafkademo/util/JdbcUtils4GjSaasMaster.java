 ...
 */
@Slf4j
public class JdbcUtils4GjSaasMaster {
    ...
    public static List<String> getAllTableNameFromDS() {
        ...
        try {
            ...
            log.error("JdbcUtils4Saas get connection failure", e);
        }
    ...
    public static Connection getConnection() {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            connection = DriverManager.getConnection("jdbc:mysql://192.168:3306/saas_prod?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&tinyInt1isBit=false&allowMultiQueries=true&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true", "gjselect", "gjselect123456");
        } catch (Exception e) {
