...
public class JdbcUtils4Yn {
     ...
     * 获取当前数据库下的所有表名称
     */
    public static List<String> getAllTableNameFromDS() {
        List<String> tables = new ArrayList();
        ...
        try {
            ...
            log.error("JdbcUtils4Yn get connection failure", e);
        }
    ...
    public static Connection getConnection() {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            // yn-saas saas_ds_3
            // connection = DriverManager.getConnection("jdbc:mysql://192.168.80.27:3306/saas_ds_3?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&tinyInt1isBit=false&allowMultiQueries=true&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true", "root", "123456");
