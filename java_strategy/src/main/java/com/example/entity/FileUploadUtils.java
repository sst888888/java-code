...
import com.example.entity.MinioConfig;
import org.apache.commons.io.FilenameUtils;
import org.apache.tika.Tika;
import org.springframework.web.multipart.MultipartFile;
import com.example.entity.RuoYiConfig;
import com.example.entity.Constants;
import com.example.entity.FileNameLengthLimitExceededException;
import com.example.entity.FileSizeLimitExceededException;
import com.example.entity.InvalidExtensionException;
import com.example.entity.DateUtils;
import com.example.entity.StringUtils;
import com.example.entity.Seq;
...
public class FileUploadUtils {
    ...
    public static final String extractFilename(MultipartFile file) throws IOException {
        ...
        if (!Objects.equals(extension, detect)) {
            throw new IOException("非法上传操作");
        }

        return StringUtils.format("{}/{}_{}.{}", DateUtils.nowDateStr(DateUtils.yyyy_MM_dd_02),
