...
public class RedisCache {
    ...
    public void addSetMembers(String key, Set<String> values) {
        //开启管道
        redisTemplate.executePipelined((RedisCallback<List<String>>) connection -> {
    ...
    public void addSetMembers(String key, List<Long> values) {
        //开启管道
        redisTemplate.executePipelined((RedisCallback<List<String>>) connection -> {
            for (Long value : values) {
                //添加执行命令
                connection.setCommands().sAdd(key.getBytes(), value.toString().getBytes());
            }
            return null;
        });
