package com.example.redundantcode.cache.invalid;
...
public class CacheInvalidController {
    ...
    public void wrongInit() {
        ...
        Executors.newSingleThreadScheduledExecutor().scheduleAtFixedRate(() -> log.info("DB QPS : {}", atomicInteger.getAndSet(0)),
