package com.example.redundantcode.reflection.right;
...
public class BetterBankService {
    ...
    private static String remoteCall(AbstractAPI api) throws IOException {
                    ...
                    switch (bankAPIField.type()) {
                        ...
                        case "M": {
                            if (!(value instanceof BigDecimal))
                                throw new RuntimeException(String.format("%s的%s必须是BigDecimal", api, field));
        ...
        //发请求
        String result = Request.Post("http://localhost:8160/reflection" + bankAPI.url())
